/*
  ...
  Version v11.1p_2017-10-11/EVAL Deployment (2017-10-11)
...
if (window.isc && isc.version != "v11.1p_2017-10-11/EVAL Deployment" && !isc.DevUtil) {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v11.1p_2017-10-11/EVAL Deployment'. Mixing resources from different "
...
isc.TabSet.addProperties({
    ...
    // Explicitly call out titleEditorProperties as TextItem common so it gets
    // picked up in SGWT
...
addTabs : function (newTabs, position) {
    ...
    for (var i = 0; i < newTabs.length; i++) {
        ...
        // Actually add the tab to the common
...
removeTabs : function (tabs, dontDestroy) {
    ...
    for (var i = 0; i < tabs.length; i++) {
        ...
        // remove the tab from the common
        var tab = tabs[i],
...
getTab : function (tab) {
    ...
    // if we have a tab-common block, convert it to an index, since the tabBar doesn't see our
    // 'tabs' array
...
// This means if a tabset subclass is created with tabs explicitly set to a bunch of common
